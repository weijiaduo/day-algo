...
- [面试题 10.10. 数字流的秩](array/StreamRank.java)
- [面试题 16.06. 最小差](array/SmallestDifference.java)
...
- [面试题 10.09. 排序矩阵查找](matrix/SearchMatrix.java)
- [面试题 16.04. 井字游戏](matrix/Tictactoe.java)
...
- [面试题 16.09. 运算](math/Operations.java)
