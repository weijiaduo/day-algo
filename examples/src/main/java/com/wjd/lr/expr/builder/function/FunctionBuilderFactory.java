...
import com.wjd.lr.expr.builder.function.dialect.*;

import static com.wjd.lr.expr.builder.function.DialectType.*;
...
public class FunctionBuilderFactory {
    ...
    public static FunctionBuilder create(String type) {
        switch (type) {
