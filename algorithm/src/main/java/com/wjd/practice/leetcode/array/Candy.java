 ...
 * @since 2022/6/27
 */
public class Candy implements Solution<Integer> {
     ...
     */
    private int leftRightCandy(int[] ratings) {
     ...
     */
    private int upDownCandy(int[] ratings) {
        int n = ratings.length;
        int ret = 1;
