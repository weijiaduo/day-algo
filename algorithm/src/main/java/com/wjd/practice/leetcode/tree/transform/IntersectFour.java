...
public class IntersectFour {
    ...
    //     }
    //     if (quadTree2.isLeaf) {
    //         return intersect2(quadTree2, quadTree1);
    //     }
    //     Node o1 = intersect2(quadTree1.topLeft, quadTree2.topLeft);
    //     Node o2 = intersect2(quadTree1.topRight, quadTree2.topRight);
    //     Node o3 = intersect2(quadTree1.bottomLeft, quadTree2.bottomLeft);
    //     Node o4 = intersect2(quadTree1.bottomRight, quadTree2.bottomRight);
    //     if (o1.isLeaf && o2.isLeaf && o3.isLeaf && o4.isLeaf && o1.val == o2.val
    //             && o1.val == o3.val && o1.val == o4.val) {
